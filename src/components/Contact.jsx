...
function Contact() {
  return (
    <div>
      <section class="text-white mt-15 bg-gradient-to-r from-gray-900 via-indigo-900 to-orange-900 text-white px-4 py-0 shadow-lg">
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <a class="text-white">jarralhuzaifa8@gmail.com</a>
          <p class="leading-normal pt-2 pb-2">Ittefaq Town Near Wahdat Road, Lhr.
            <br />98-Saleem-Block
          </p>
        </div>
      </div>
